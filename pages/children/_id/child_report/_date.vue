  ...
  <v-container>
    ...
    <v-container style="width: 80%">
      <v-form>
            ...
            <v-alert color="hogosya" outlined border="left">
              ...
              <v-row>
                <v-col>
                  体温：
                  <span
                    v-if="parents_report.body_temperature === null"
                    class="black--text"
                  >
                    未入力
                  </span>
                  <span v-else class="black--text">
                    {{ parents_report.body_temperature }}度
                  </span>
                </v-col>
              </v-row>
              <v-row>
                <v-col>
                  ...
                  <span class="black--text">
                    <span v-if="parents_report.is_cold_symptom === null">
                      未入力
                    </span>
                    <span v-else-if="parents_report.is_cold_symptom === false">
                      良い
                    </span>
                    <span v-else> 悪い </span>
                  </span>
              ...
              <v-row
                v-if="
                  (parents_report.is_cough === null &&
                    parents_report.is_snot === null) ||
                    parents_report.is_cold_symptom === false
                "
              />
              <v-row v-else>
                <v-col>
                  ...
                  <span class="black--text">
                    <span
                      v-if="
                        parents_report.is_cough === true &&
                          parents_report.is_snot === true
                      "
                    >
                      咳、鼻水
                    </span>
                    <span v-else-if="parents_report.is_cough === true">
                      咳
                    </span>
              ...
              <v-row
                v-if="
                  (parents_report.is_taste === null &&
                    parents_report.is_smell === null) ||
                    parents_report.is_cold_symptom === false
                "
              />
              <v-row v-else>
                <v-col
                  v-if="
                    parents_report.is_taste === true ||
                      parents_report.is_smell === true
                  "
                >
                  新型コロナウィルスの疑い：
                  <span class="black--text">
                    ...
                    <v-col v-else-if="parents_report.is_taste === true">
                      味覚異常あり
                    </v-col>
              ...
              <v-row
                v-if="
                  parents_report.cold_symptoms_description === '' ||
                    parents_report.cold_symptoms_description === null ||
                    parents_report.is_cold_symptom === false
                "
              />
              <v-row v-else>
        ...
        <v-row
          v-if="
            parents_report.is_cold_symptom === true &&
              is_p &&
              childminder_report.is_completed === null
          "
        >
          <v-col>
            <v-checkbox
        ...
        <span v-else>
          <v-row>
            <v-col>
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row
                  v-if="
                    parents_report.mood_description === '' ||
                      parents_report.mood_description === null ||
                      parents_report.mood !== 2
                  "
                />
                <v-row v-else>
                  <v-col>
          ...
          <span
            v-if="is_p === false && childminder_report.is_completed !== true"
          >
            <v-row>
              <v-col>
                ...
                <v-alert color="hoikushi" outlined border="left">
                  ...
                  <v-row>
                    <v-col>
                      機嫌：
                      <span class="black--text">
                        <span v-if="childminder_report.mood === null">
                          未入力
                        </span>
                        <span v-else-if="childminder_report.mood === 0">
                          良い
                        </span>
                        <span v-else-if="childminder_report.mood === 1">
                          普通
                        </span>
                        <span v-else> 悪い </span>
                      </span>
                  ...
                  <v-row
                    v-if="
                      childminder_report.mood_description === '' ||
                        childminder_report.mood_description === null ||
                        childminder_report.mood !== 2
                    "
                  />
                  <v-row v-else>
                    <v-col>
              ...
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    薬の有無：
                    <span class="black--text">
                      <span v-if="parents_report.is_medicine === null">
                        未入力
                      </span>
                      <span v-else-if="parents_report.is_medicine === true">
                        あり
                      </span>
                      <span v-else> なし </span>
                    </span>
                ...
                <v-row
                  v-if="
                    parents_report.medicine_description === '' ||
                      parents_report.medicine_description === null ||
                      parents_report.is_medicine === false
                  "
                />
                <v-row v-else>
                  <v-col>
                ...
                <v-alert color="hoikushi" outlined border="left">
                  ...
                  <v-row>
                    <v-col>
                      お薬：
                      <span class="black--text">
                        <span v-if="childminder_report.is_medicine === null">
                          未入力
                        </span>
                        <span
                          v-else-if="childminder_report.is_medicine === true"
                        >
                          飲みました
                        </span>
              ...
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    朝の食欲：
                    <span class="black--text">
                      <span v-if="parents_report.appetite === null">
                        未入力
                      </span>
                      <span v-else-if="parents_report.appetite === 0">
                        よく食べた
                      </span>
                      <span v-else-if="parents_report.appetite === 1">
                        普通
                      </span>
                ...
                <v-row
                  v-if="
                    parents_report.appetite_description === '' ||
                      parents_report.appetite_description === null ||
                      parents_report.appetite !== 2
                  "
                />
                <v-row v-else>
                  <v-col>
                ...
                <v-alert color="hoikushi" outlined border="left">
                  ...
                  <v-row>
                    <v-col>
                      保育園での食欲：
                      <span class="black--text">
                        <span v-if="childminder_report.appetite === null">
                          未入力
                        </span>
                        <span v-else-if="childminder_report.appetite === 0">
                          よく食べた
                        </span>
                        <span v-else-if="childminder_report.appetite === 1">
                          普通
                        </span>
                        <span v-else> あんまり </span>
                      </span>
                  ...
                  <v-row
                    v-if="
                      childminder_report.appetite_description === '' ||
                        childminder_report.appetite_description === null ||
                        childminder_report.appetite !== 2
                    "
                  />
                  <v-row v-else>
                    <v-col>
              ...
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    就寝：
                    <span class="black--text">
                      <span v-if="parents_report.bed_time === null">
                        未入力
                      </span>
                ...
                <v-row>
                  <v-col>
                    起床：
                    <span class="black--text">
                      <span v-if="parents_report.wake_up_time === null">
                        未入力
                      </span>
              ...
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    時間：
                    <span class="black--text">
                      <span v-if="parents_report.pick_up_time === null">
                        未入力
                      </span>
                ...
                <v-row>
                  <v-col>
                    ...
                    <span class="black--text">
                      <span
                        v-if="
                          parents_report.pick_up_person === '' ||
                            parents_report.pick_up_person === null
                        "
                      >
                        未入力
                      </span>
            ...
            <v-col>
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    <span class="black--text">
                      <span v-if="parents_report.notification === null">
                        未入力
                      </span>
                      <span v-else-if="parents_report.notification === ''">
                        特になし
                      </span>
              ...
              <v-col>
                <v-alert color="hoikushi" outlined border="left">
                  ...
                  <v-row>
                    <v-col>
                      <span class="black--text">
                        <span v-if="childminder_report.notification === null">
                          未入力
                        </span>
                        <span
                          v-else-if="childminder_report.notification === ''"
                        >
                          特になし
                        </span>
                        <span v-else>
                          {{ childminder_report.notification }}
                        </span>
                      </span>
                    </v-col>
                  </v-row>
            ...
            <v-col>
              <v-alert color="hogosya" outlined border="left">
                ...
                <v-row>
                  <v-col>
                    <span class="black--text">
                      <span v-if="parents_report.description === null">
                        未入力
                      </span>
                      <span v-else-if="parents_report.description === ''">
                        特になし
                      </span>
              ...
              <v-col>
                <v-alert color="hoikushi" outlined border="left">
                  ...
                  <v-row>
                    <v-col>
                      <span class="black--text">
                        <span v-if="childminder_report.description === null">
                          未入力
                        </span>
                        <span v-else-if="childminder_report.description === ''">
                          特になし
                        </span>
                        <span v-else>
                          {{ childminder_report.description }}
                        </span>
                      </span>
                    </v-col>
                  </v-row>
        ...
        <span
          v-if="
            (is_p === false && childminder_report.is_completed === false) ||
              (is_p === false && childminder_report.is_completed === null)
          "
        >
          <v-row>
            <v-btn
        ...
        <v-row
          v-if="
            (childminder_report.is_completed === null && is_p == true) ||
      ...
      <v-row v-if="success" widht="100px">
        <v-col>
          <v-btn
            ...
            class="font-weight-bold"
          >
            <v-spacer />保存できました<v-spacer /><v-icon
              >mdi-close</v-icon
            ></v-btn
          >
        </v-col>
...
export default {
  ...
  methods: {
    ...
    body_temperature_update() {
      this.parents_report.body_temperature = this.parents_report.body_temperature.toFixed(
        1
      );
    }
  }
